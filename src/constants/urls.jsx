...
export const TEACHER_LOGIN = "/index/teacher_login";
export const TEACHER_FORGOT = "/index/forgot_password";
export const TEACHER_OTP = "/index/verify_otp_instructor";
export const TEACHER_PROFILE = "/index/instructor_teacher_detial";
